...
$plans = [
    'basic' => ['name' => 'Basic', 'price' => 149, 'features' => ['Full Mock Tests', 'Rapid Fire & Subject Tests', 'Weekly Challenges', 'Community Read Access', 'Basic Analytics']],
    'pro' => ['name' => 'Pro', 'price' => 299, 'features' => ['Everything in Basic', 'Previous Year Papers', 'Revision Mode', 'Challenge a Friend', 'Full Analytics & PDF Reports', 'Leaderboard Access', 'Priority Support']],
];
